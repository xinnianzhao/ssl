#!/usr/bin/env python3
"""
Generate ASR predictions using finetuned Whisper model on CGN test dataset.
"""
...
from tokenizer.bpe_aed_tokenizer import BPEAEDTokenizer


class CustomProcessor(ProcessorMixin):
    """Custom processor combining WhisperFeatureExtractor and BPEAEDTokenizer."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate ASR predictions using finetuned Whisper model on CGN test dataset")
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to finetuned Whisper model directory"
    )
...
def main():
    ...
    # Patch model to use basic generation
